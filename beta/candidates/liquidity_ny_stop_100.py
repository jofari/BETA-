"""liquidity_ny_stop_100 — R8 : fader la premiere bougie de l'open New York.

Variante du balayage de la distance de stop : stop a l'amplitude entiere, donc
au-dela du niveau balaye et non dedans.
...
def creer() -> Candidate:
    return Candidate(
        nom="liquidity_ny_stop_100",
        titre="Fade open NY — stop 1,0x amplitude",
        hypothese="R8",
        signaux=signaux,
        ...
        description="entrer a 10:15 New York dans le sens oppose au corps de la fenetre "
                    "09:30-10:15, stop a 1x son amplitude")
